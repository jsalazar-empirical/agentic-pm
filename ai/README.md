...
The outer loop (`/sdd-ticket`, `/sdd-board`, `/sdd-task`, `/sdd-spec-from-ticket`,
`/sdd-pr`) connects this scaffold to Linear and GitHub. Coordinates live in
`ai/context/integrations.md`; setup is in `../INTEGRATIONS.md`.
